import type { Solution, Survey, Topic, TopicCoverage } from "@/lib/types";
import type { QA } from "@/lib/repo/sessions";
import type { ChatMessage } from "./client";

const VOICE = `# 質問の声（必ず守る）
- 丁寧だが硬くない。「〜についてお聞かせください」「ご回答ください」「〜でしょうか」の連発は禁止。
...
- intro_text は回答者向けの導入文（2〜3文、120字以内）。会話の始まりのように書く。「アンケートにご協力ください」は禁止。匿名であることと、答えによって質問が変わることに触れる。${solutionGuide}
